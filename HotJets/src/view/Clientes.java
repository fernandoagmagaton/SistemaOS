...
public class Clientes extends JDialog {
	...
	public Clientes() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Clientes.class.getResource("/img/carwash64.png")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(Clientes.class.getResource("/img/carwash64.png")));
		...
		lblNewLabel.setBounds(0, 462, 784, 99);
